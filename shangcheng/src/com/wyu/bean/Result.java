...
public class Result {
	...
	public String toString() {
		return "Result [appid=" + appid + ", bank_type=" + bank_type + ", cash_fee=" + cash_fee + ", is_subscribe="
				+ is_subscribe + ", mch_id=" + mch_id + ", nonce_str=" + nonce_str + ", openid=" + openid
				+ ", out_trade_no=" + out_trade_no + ", result_code=" + result_code + ", return_code=" + return_code
				+ ", sign=" + sign + ", time_end=" + time_end + ", total_fee=" + total_fee + ", trade_type="
